	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 1,
					"patching_rect" : [ 1125.0, 110.0, 25.0, 25.0 ],
					"outlettype" : [ "" ],
					"comment" : "quantize ON/OFF"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 456.0, 619.0, 27.662109, 23.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "int", "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 426.0, 618.0, 26.0, 26.0 ],
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 952.0, 370.0, 83.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 1,
					"patching_rect" : [ 397.0, 591.0, 85.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 619.0, 25.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 912.0, 319.0, 20.0, 20.0 ],
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 2,
					"patching_rect" : [ 912.0, 344.0, 59.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "int", "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 783.0, 315.0, 116.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "int", "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 1169.0, 144.0, 79.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "int", "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 1,
					"patching_rect" : [ 1169.0, 110.0, 25.0, 25.0 ],
					"outlettype" : [ "" ],
					"comment" : "quantize index"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 1,
					"patching_rect" : [ 301.0, 591.0, 97.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 801.0, 409.0, 96.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 301.0, 619.0, 25.0, 25.0 ],
					"comment" : "int : LoopIndex"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 266.0, 555.0, 105.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "signal" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 266.0, 619.0, 25.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.0, 646.0, 60.0, 21.0 ],
					"fontname" : "Hiragino Maru Gothic Pro W4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 781.0, 290.5, 77.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "signal", "float" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 781.0, 266.0, 165.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 866.0, 240.0, 80.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 780.638184, 240.344421, 83.0, 20.0 ],
					"fontname" : "Arial",
					"outlettype" : [ "" ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 275.5, 587.0, 269.0, 587.0, 269.0, 576.0, 185.5, 576.0 ]
				}
